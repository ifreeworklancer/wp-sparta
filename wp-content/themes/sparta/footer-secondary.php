...
<footer id="app-footer" data-color="light">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-6">
                <h2 class="section-title section-title--end mb-5 text-dark">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="footer-copyr text-center">
                    <div class="footer-copyr-item mb-3 text-dark">
                        &copy; KBSPARTA 2018
                    </div>
                    <div class="footer-copyr-item footer-copyr-item--dev text-dark">
